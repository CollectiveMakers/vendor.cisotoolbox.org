_registerTranslations("fr", {
    ...
    "vendor.import_risk": "Importer depuis Risk",
    "vendor.import_risk.no_pp": "Aucune partie prenante trouvée dans le fichier.",
    "vendor.import_risk.risk_title": "Analyse EBIOS RM — {name}",
    "vendor.import_risk.risk_desc": "Risque issu de l'analyse EBIOS RM. Menace : {menace} (D:{dep} P:{pen} M:{mat} C:{conf}).",
    "vendor.import_risk.success": "{vendors} fournisseur(s), {risks} risque(s), {measures} mesure(s) importé(e)s. {skipped} ignoré(s).",
    "vendor.import_risk.error": "Erreur d'import : {msg}",
    ...
    "assessment.export_json_title": "Exporter le questionnaire",
    "assessment.export_json_hint": "Générez un fichier à envoyer au fournisseur. Protégez-le avec un mot de passe pour chiffrer les données.",
    "assessment.encryption_password": "Mot de passe (optionnel)",
    ...
    "pp.export_hint": "Exporte les fournisseurs au format Parties Prenantes (PP) compatible avec l'application Risk.",
    "pp.import_title": "Import Risk",
    "pp.import_hint": "Importe les Parties Prenantes (PP) depuis un fichier JSON EBIOS RM.",
    ...
    "menu_export_excel": "Exporter Excel",
    "common.yes": "Oui",
    ...
    "pp.imported": "{count} fournisseur(s) importe(s) depuis EBIOS RM",
